...
/**
 * Thin orchestrator that holds UI state and delegates rendering to modular
 * renderers (MenuScreen, HUD, DialogueBox). This file replaces the large
 * monolithic UserInterface.java and keeps only orchestration logic.
 */
